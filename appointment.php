...
$query = "SELECT `Name`, `Age`, `Disease`, `Conditions`, `Address`, `Phone Number`, `Date` FROM `patient` limit $start_from_page , $num_per_page";
...
<body>
    ...
    <div class="row">
        <div class="col-sm-2 showPat showLink ">
            <ul>
    ...
    <div class="row">
        <div class="col-sm-12">
          ...
          <form action="searchAp.php" id="IdS" method="post">
               <label for="contact" class="text-white color">Search Patients by Phone Number</label>
               <input type="number" name="contact" placeholder="Search patient by phone number" class="form-control w-50"/>
                  ...
                  <tr>
                      ...
                      <td>
                        <form action="update.php" method="post">
                            <input type="hidden" name="phone" value="<?php echo "0".$rows['Phone Number']; ?>">
...
?>
       ...
       <?php
           $per_query = "SELECT `Name`, `Age`, `Disease`, `Conditions`, `Address`, `Phone Number`, `Date` FROM `patient`";
           $per_result = mysqli_query($conn, $per_query);
           $total_record  = mysqli_num_rows($per_result);
         
           $total_page = ceil($total_record/$num_per_page);
          for($i=1;$i<=$total_page;$i++){
            echo "<a href='appointment.php?page=".$i."' class='btn btn-primary text-white mr-2'>$i</a>";
          }
       ?>
