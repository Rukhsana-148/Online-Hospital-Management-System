<?php
$name = $age = $dis = $place = $phone = $date=$con = $cont="";
...
$query = "SELECT `Name`, `Age`, `Disease`, `Conditions`, `Address`, `Phone Number`, `Password`, `Date` FROM `patient` WHERE `Phone Number` = '$cont'";
    ...
    <div class="container">
        <div class="upper">
            ...
            <span class="menu"><i class="fas fa-bars"></i></span>
                <span class="back"><a href="appointment.php"><i class="fas fa-angle-left"></i></a><a href="AdminMenu.php"><i class="fas fa-arrow-alt-circle-left"></i></a><a href="index.php"><i class="fas fa-home"></i></a></span>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-2 showPat showLink ">
            <ul>
                ...
                <li><a href="patientDis.php">Admitted Patient List</a></li>
